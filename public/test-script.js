...
if (baseEl) {
  fetch('https://cors-anywhere.herokuapp.com/https://185b-64-137-155-172.ngrok.io/api/postcode?shop=extestdevstore.myshopify.com')
  .then(res => res.json())
  .then(data2 => {
  ...
  fetch('https://cors-anywhere.herokuapp.com/https://185b-64-137-155-172.ngrok.io/api/products?shop=extestdevstore.myshopify.com')
  .then(res => res.json())
  .then(async data => {
    multiStepCart(data)
    stepBar()
    ...
    fetch('https://cors-anywhere.herokuapp.com/https://185b-64-137-155-172.ngrok.io/api/cardProducts?shop=extestdevstore.myshopify.com')
      .then(res => res.json())
      .then(async data => {
          // Render 3rd UI
          thirdPartCart(data)
          ...
          fetch('https://cors-anywhere.herokuapp.com/https://185b-64-137-155-172.ngrok.io/api/deliveryInstructions?shop=extestdevstore.myshopify.com')
            .then(res => res.json())
            .then(async data => {
